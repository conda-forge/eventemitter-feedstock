About eventemitter-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eventemitter-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/asyncdef/eventemitter

Documentation: https://pypi.org/project/eventemitter/#description
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10137&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eventemitter-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eventemitter` can be installed with `conda`:
...
```
mamba install eventemitter
```

It is possible to list all of the versions of `eventemitter` available on your platform with `conda`:
...
```
mamba search eventemitter --channel conda-forge
```
...
mamba repoquery search eventemitter --channel conda-forge

# List packages depending on `eventemitter`:
mamba repoquery whoneeds eventemitter --channel conda-forge

# List dependencies of `eventemitter`:
mamba repoquery depends eventemitter --channel conda-forge
```
